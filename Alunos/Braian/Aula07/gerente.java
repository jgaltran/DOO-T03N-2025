package Alunos.Braian.Aula07;
 class Gerente extends Pessoa{
  ...
  public Gerente(String nome, Integer idade, String loja, String cidade, String bairro, String rua, Double salarioBase, Endereco endereco){
      this.nome = nome;
      this.idade = idade;
      this.loja = loja;
      this.cidade = cidade;
      ...
      this.endereco = new Endereco(estado, cidade, bairro, nomeRua, numeroRua, complemento);
  }
  @Override
