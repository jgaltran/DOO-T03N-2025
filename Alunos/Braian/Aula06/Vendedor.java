  ...
  public Vendedor(String nome, int idade, String loja, String cidade, String bairro, String rua, Double salarioBase, Double salarioRecebido){
    ...
    this.salarioRecebido = new Double[]{1780.00, 1810.00, 1850.00};
      ...
      public String toString(){
        return "Vendedor [nome=" + nome + ", idade=" + idade + ", loja=" + loja + ", cidade=" + cidade + ", bairro=" + bairro + ", rua=" + rua + ", salarioBase=" + salarioBase + ", salarioRecebido=" + salarioRecebido[0] + ", " + salarioRecebido[1] + ", " + salarioRecebido[2] + "]";
      }
      ...
      public void calcularBonus(){
        System.out.println("O bônus é: " + this.salarioBase * 0.2);
      }
