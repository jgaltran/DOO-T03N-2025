...
public class Principal {
	...
	public static void menuPrincipal(){
		...
		if(op==1) { calcularPreco();
			...
			System.out.println("ERRO- digite uma opção válida (de 1 a 6!)");
	...
	System.out.println("Dona Gabrielinha, insira a quantidade vendida da planta desejada, por gentileza!:");
	...
	public static void calcularTroco() {
		...
		System.out.println("Dona Gabrielinha, insira o valor pago pelo cliente, por gentileza:");
