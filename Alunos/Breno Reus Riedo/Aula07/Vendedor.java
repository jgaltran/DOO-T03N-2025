...
public class Vendedor extends Sujeito {
    private Loja loja;
    private BigDecimal salarioBase;
    private List<BigDecimal> salarioRecebido;


    public Vendedor(String nome, int idade, Loja loja, Endereco endereco, BigDecimal salarioBase, List<BigDecimal> salarioRecebido) {
